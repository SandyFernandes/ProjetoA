...
<html lang="pt-br">
	...
	<body style="background: #000000">
			...
			<a class="navbar-brand" href="feminas (2).php"><img src="logo.png" class="img-fluid" style="width:70px; height:70px; "/></a>
				  ...
				  <div class="collapse navbar-collapse" style="background: #000000" id="conteudoNavbarSuportado">
					<ul class="navbar-nav mr-auto">
					  ...
					  <li class="nav-item">
						<a class="nav-link" href="somos.php"><span style="color:pink;"><i class="fas fa-user-tie"
						></i></span> Quem somos </a>
					  </li>
			...
			<div class="container">
				...
				<div class="row">
						<div class="col-md-12 text-center"><h1>BEM VINDO A SANSU-MODA </h1>
						</div>
						<br><br><br><br><br>
						<div class="col-12 text-center">
						<img src="ll.jpg" class="img-fluid" style="border: outset 3px pink;"/>
						</div>
					</div><br><br><br>
